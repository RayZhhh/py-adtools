...
from adtools.sandbox import SandboxExecutor, SandboxExecutorRay, sandbox_run
...
if __name__ == "__main__":
    trainer = Trainer()
    res = trainer.train_mp_sandbox()
    print(res)

    res = trainer.train_ray_sandbox()
    print(res)
